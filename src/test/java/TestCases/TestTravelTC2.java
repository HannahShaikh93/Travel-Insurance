...
import Components.Travel2;
import Utilities.BaseClass;
import Utilities.XLUtils;


public class TestTravelTC2 extends BaseClass {
	
		
		
		String expected_ID = "Travel2";
...
//			if (TestCaseID.equalsIgnoreCase(expected_ID)) {
			...
			SC_Travel.Details();
			SC_Travel.StartScreening();
			SC_Travel.MedicalScreening();
			SC_Travel.MedicalProceed();
			SC_Travel.ChooseCover();
			SC_Travel.CustomisePolicy();
			SC_Travel.MedicalAddCover();
			SC_Travel.NextPayment();
			SC_Travel.Payment();
